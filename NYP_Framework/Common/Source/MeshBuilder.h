...
public:
	...
	Mesh* GenerateQuadBackground(const std::string &meshName, Color color, float length = 1.f);
	...
	SpriteAnimation* GenerateSpriteAnimation(const std::string &meshName, unsigned numRow, unsigned numCol, float alpha);
