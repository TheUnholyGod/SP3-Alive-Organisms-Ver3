...
public:
	...
	virtual void SetStatic(const bool _value);

	virtual void SetIsParticleEmitter(const bool _value);

	virtual void SetTileID(const int _value);

	int GetTileID();
	bool GetIsStatic();
	bool GetIsParticleEmitter();
